...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { first_name: @rsvp.first_name, last_name: @rsvp.last_name, status: @rsvp.status }
    end
  ...
  test "should update rsvp" do
    put :update, id: @rsvp, rsvp: { first_name: @rsvp.first_name, last_name: @rsvp.last_name, status: @rsvp.status }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
